...
- Технологии: Linux 🐧, SSH, Bash, Python 🐍, Java, MS Excel, Git, Jenkins, API, Insomnia, QA
...
Образование 🎓
- Магистратура ВШЭ — "Инженерия данных" (2 курс).
- Курс по python:
  - https://stepik.org/cert/2444855
  - https://stepik.org/cert/2347363
- Бакалавр РГУ Губкина "Разработка нефтяных и газовых месторождений" (закончил в 2024 году).
